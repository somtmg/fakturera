...
const content = {
  "en_content" : `BY clicking Invoice Now, you choose to register according to the information that you have typed in and the text on the registration page and the terms here, and you at the same time accept the terms here.
...
Have a great day!`,
"sv_content" : `GENOM ATT klicka på Fakturera Nu så väljer ni att registrera enligt den information som ni har lagt in och texten på registrerings sidan och villkoren här, och accepterar samtidigt villkoren här.
...
const translations = [
  ...
  { key: 'terms_content', language: 'sv', value: `${content.sv_content}` },
  { key: 'terms_content', language: 'en', value: `${content.en_content}`  },
];
